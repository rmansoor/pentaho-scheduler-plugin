...
public class RunInBackgroundCommand extends AbstractCommand {
  ...
  protected void performOperation(String repositoryFileId, String repositoryPath, boolean feedback ) {
  ...
  /*-{
    $wnd.pho.executeRunInBackground = function( repositoryFileId,repositoryFilePath,feedback) {
      cmd.@org.pentaho.mantle.client.commands.RunInBackgroundCommand::
    }
